...
An example of how textual information from an article is being transformed into a diagram in the SBGN Process Description format in CellDesigner is shown on a dedicated ["Text to SBGN"](../text-to-sbgn) page.  

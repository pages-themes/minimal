...
Suggested fileds for map annotation are listed in the table below. In CellDesigner this type of annotation can be added via Component > Model Information, Component > Model Description, Component > Model MIRIAM Info and Component > Model Notes. Some fields can be annotated on [upload to MINERVA](https://minerva.pages.uni.lu/doc/examples/v16.0/04-advanced-upload/): map ID, map name, taxonomy ID, disease ID and map version.

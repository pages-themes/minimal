...
<td style="width: 320px; text-align: left; vertical-align: top; background-color: #c3cfe0;"><p style="margin-top:6px; font-size:16px;"><strong><a href="../parkinsons" target="_blank">Parkinson's disease</a></strong></p><p style="line-height:180%; margin-top:6px; font-size:13px;">
        Resource: Parkinson's Disease Map<br />
        Contact: Marek Ostaszewski, University of Luxembourg, Belvaux, Luxembourg<br />
        Country: <img src="../images/flags/flag-of-Luxembourg.png" width="30"/> Luxembourg
        </p></td>

...
We plan afternoon breakout discussion sessions following the example of the <a href="http://disease-maps.org/DMCM2017_2nd" target="_blank">2nd Disease Maps Community Meeting</a> in Luxembourg. We invite proposals from all participants. 4-6 topics will be selected, introduced 2 October and discussed 3 and 4 October with summary presentations for the community. The discussions will be described in the anticipated publications. A report from the Luxembourg meeting was published receintly in <i>Briefings in Bioinformatics</i>: <a href="https://doi.org/10.1093/bib/bby024" target="_blank">doi: 10.1093/bib/bby024</a>

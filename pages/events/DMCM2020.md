...
The registration is free but mandatory for all presenters and attendees. Please fill in the <a href="https://forms.gle/6wjFaQ68fCptdvQW6"><strong><font color="Navy">registration form here</font></strong></a> by <font color="red">5 November 2020</font>.  
...
This webpage is the main entry point for accessing all events of the programme.  We run this meeting using Webex Meetings, with the posters deposited on Zenodo platform. The live talks and the discussion panels will take place in Webex rooms, whereas the personal profiles of the participants and virtual posters will be displayed on the Zenodo platform.

Useful infromation about participating in the conference, as well as our code of conduct, [can be found here](https://disease-maps.org/DMCM2020info){:target="_ blank"}.
